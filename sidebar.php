	<div id="sideBar">
	    ...
	    <div class="widget">
	        <div class="widgetPhoto">
	            ...
	            <?php /* <object data='<?php bloginfo('template_url'); ?>/video/mpw_player.swf'
	            type='application/x-shockwave-flash' width='273' height='202' style='margin-top:8px;'>
	            ...
	            <div class="theImageURL"
	                style="height:<?php echo $theLarge[2]."px"; ?>; width:<?php echo $theLarge[1]."px"; ?>;">
	                <?php echo $theLarge[0] ?></div>
	            <img src="<?php echo $theThumb; ?>" width='273' height='202' style="margin-top:8px;" />
	            <?php endif; //if(get_field('the_video')):?>
	        </div>
	        <!--/widgetPhoto-->
	        <img alt="Frame" class="frame fn" src="<?php bloginfo('template_url'); ?>/images/gildedFrameN.png" width="319"
	            height="40" />
	        <img alt="Frame" class="frame fw" src="<?php bloginfo('template_url'); ?>/images/gildedFrameW.png" width="34"
	            height="185" />
	        <img alt="Frame" class="frame fe" src="<?php bloginfo('template_url'); ?>/images/gildedFrameE.png" width="33"
	            height="185" />
	        <img alt="Frame" class="frame fs" src="<?php bloginfo('template_url'); ?>/images/gildedFrameS.png" width="319"
	            height="38" />
	    </div>
	    <!--/widget-->
